...
* The following dependencies are not known to work with Spring Native: 'Spring Configuration Processor, Spring Boot
  DevTools, Rest Repositories, Spring Web Services, Spring REST Docs'. As a result, your application may not work as
  expected.
...
```
$ docker run --rm -p 8080:8080 springboot-crud:0.0.1-SNAPSHOT
```
